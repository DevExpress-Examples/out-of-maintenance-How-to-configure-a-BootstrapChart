<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetupInMarkup.aspx.cs" Inherits="ChartApi.SetupInMarkup" %>
<%@ Register Assembly="DevExpress.Web.Bootstrap.v20.2, Version=20.2.12.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web.Bootstrap" TagPrefix="dx" %>
<%@ Register Assembly="DevExpress.Web.v20.2, Version=20.2.12.0, Culture=neutral, PublicKeyToken=b88d1754d700e49a" Namespace="DevExpress.Web" TagPrefix="dx" %>
<!DOCTYPE html>
